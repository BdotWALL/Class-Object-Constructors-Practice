...
//A printProduct() method that prints how much one unit of the product costs and how many units were purchased.
      public void printProduct() {
          if(this.quantity < 2) {
            System.out.println(this.name + " costs " + this.productCost + " and " + this.quantity + " unit was purchased." );
          }else {
            System.out.println(this.name + " costs " + this.productCost + " and " + this.quantity + " units were purchased.");
          }
      }
