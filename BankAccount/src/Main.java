...
Withdraw 100 dollars from the first account and deposit 100 dollars in the second account using the methods created in the BankAccount class. */
        ...
        double balanceAfterWithdraw = accountHolder2.withdrawl(100.00); //Withdraws 100 from Larry's account
        ...
        double balanceAfterTheDeposit = accountHolder3.deposit(100.00); //Deposits 100 to Mary's account
